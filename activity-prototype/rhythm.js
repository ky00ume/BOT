...
let mode='easy',chart=[],running=false,starting=false,runId=0,startAt=0,raf=0,combo=0,score=0,hits=0,judged=0,totalErr=0,runes=0,phase='theme',memory=[],improvStart=0,improvEnd=0,callPlayed=false,responseRule='mirror';
