...
function frame(){if(!running)return;const t=now(),h=els.stage.clientHeight,judgeY=h-parseFloat(getComputedStyle(els.stage).getPropertyValue('--receptor-y')||72);
