...
function buildSpaceChart(speed=1){
 if(mode!=='hard')return [];const b=BEAT/speed,start=900/speed,bar=b*4,usable=Math.max(1,Math.floor((56000/speed)/bar)-2),out=[];
