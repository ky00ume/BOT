...
NPC_DATA = {
    ...
    "그리스타": {
        ...
        "location": "비전 타운 여관",
        "inn": True,
        "desc": "하프 엘프 여관 주인. 과거 모험가였으나 부상으로 은퇴한 뒤 언더다크에 여관을 열었다. 무뚝뚝하지만 손님에게 따뜻한 수프를 끓여준다. 과거를 묻는 것을 싫어한다.",
        "appearance": "흰 머리가 섞인 짧은 갈색 머리에 왼쪽 눈 위로 지나가는 긴 흉터가 있다. 가죽 앞치마를 두르고 팔을 걷어붙인 채 카운터를 닦고 있다.",
        "greetings": [
            "어서 와. 빈 방 있어. 쉬고 싶으면 말해.",
            "...뭐, 앉아. 일단 수프라도 마셔.",
            "여관이야 여관. 잠자고 밥 먹고 가는 곳. 더 뭘 원하는 거야.",
            "또 왔어? — 아, 아니, 싫다는 게 아니야. 앉아.",
        ],
    },
}
