...
NPC_DATA = {
    ...
    "팅커벨": {
        "name": "팅커벨",
        "role": "요정 마법사",
        "location": "비전 타운 요정 정원",
        "desc": "장난기 넘치고 호기심이 왕성한 초록빛 요정. 마을에 어느 날 갑자기 나타나 정착했으며, 자신의 벨 아이템을 매우 아끼고 소중히 여긴다. 사람을 도울 때 보람을 느끼지만 돌려받는 것도 당연히 챙긴다.",
        "appearance": "온몸이 초록빛을 띠는 날개 달린 요정. 커다란 귀와 빛나는 초록 눈이 특징이며, 나뭇잎으로 만든 의상을 입고 있다. 뒤로 올려 묶은 머리칼도 초록빛이다.",
        "greetings": [
            "잠깐만, 잠깐! 나 팅커벨! 뭔가 필요해? 내가 해결해줄게~",
            "오, 왔구나! 오늘은 뭔가 재미있는 거 없어? 난 심심한 거 정말 싫거든.",
            "이 벨 소리 들려? 딸랑딸랑~ 좋은 일이 생긴다는 뜻이야, 어쩌면.",
            "마법? 나한테 물어봐. 어지간한 건 다 알아. 어지간하지 않은 것도 좀 알고.",
        ],
        "job": {
            "name": "요정 심부름",
            "reward_gold": 180,
    ...
    "파울": {
        ...
        "location": "비전 타운 여관",
        "inn": True,
        "desc": "드웨가 드워프 여관 주인. 완고하고 고집이 센 할배 꼰대 스타일. 결벽이 있어서 여관을 더럽히는 손님을 매우 싫어한다. 맥주와 돈을 좋아하며, 매일 수염을 정성껏 땋아 묶는다.",
        "appearance": "드로우 스타일의 짙푸른 피부에 덥수룩한 수염을 잘 땋아놓은 드워프. 드워프 나이로 중년 정도의 외형이며, 푸른색 눈을 가지고 있다. 멀끔한 인상.",
        "greetings": [
            "뭐야, 또 왔어. 들어올 거면 발 좀 닦고 와.",
            "...흠. 자리 있으니까 앉아. 더러운 짓만 안 하면 돼.",
            "여관이다, 여관. 먹고 자고 가는 곳이야. 괜한 소란은 사절이야.",
            "맥주 한 잔 할 거면 카운터로 와. 바닥에 흘리면 가만 안 둬.",
        ],
    },
}
