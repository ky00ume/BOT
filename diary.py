...
_DEFAULT_DIARY_ENTRIES = [
    ...
    "오늘은 마을 광장에서 알피라 언니가 노래하는 걸 들었슴미댜. 너무 아름다웠슴미댜... 🎵",
    "오늘은 몰이랑 같이 짐을 날랐슴미댜. 힘들었지만 간식을 줘서 기분이 좋았슴미댜~ 🍪",
    "오늘은 밤하늘의 별을 세었슴미댜. 47개까지 세다가 잠들어 버렸슴미댜... ⭐💤",
    "오늘은 다몬 아저씨 대장간에서 따뜻한 차를 마셨슴미댜. 불꽃 소리가 편안했슴미댜 ☕🔥",
    "오늘은 아라벨라랑 마법 연습을 했슴미댜. 아직 어렵지만 재밌슴미댜! ✨🔮",
    "오늘은 제블로어 아저씨랑 마을 순찰을 했슴미댜. 마을이 안전해서 다행임미댜! 🛡️",
    "오늘은 바람이 많이 불었슴미댜. 거미줄이 날아갈 뻔했슴미댜...ㅠㅠ 🍃",
    "오늘은 맛있는 수프를 만들어 먹었슴미댜! 브룩샤가 가르쳐준 대로 했더니 잘 됐슴미댜~ 🍲",
