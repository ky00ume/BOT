...
QUEST_DB = {
    ...
    "q_damion_collect_normal": {
        ...
        "desc":         "그림포지 깊은 곳에서 미스릴 광석을 3개 캐와라.",
    },
    ...
    "q_damion_kill_easy": {
        ...
        "reward_exp":   40,
        "reward_item":  None,
        "desc":         "드레드 할로우에서 몬스터 5마리를 처치해 재료를 구해와라.",
    },
    "q_damion_kill_normal": {
        ...
        "type":         "kill",
        "difficulty":   "normal",
        "target_zone":  "폐허가 된 마을",
        "target_count": 10,
        "reward_gold":  600,
        "reward_exp":   100,
        "reward_item":  "copper_bar",
        "desc":         "폐허가 된 마을에서 몬스터 10마리를 물리쳐라.",
    },
    "q_damion_kill_hard": {
        "name":         "광산의 악몽",
        "npc":          "데리스 본클록",
    ...
    "q_damion_deliver_easy": {
        ...
        "reward_exp":   100,
        "reward_item":  "iron_bar",
        "desc":         "데리스 본클록의 편지를 데리스 본클록에게 전달하고 돌아와.",
    },
    "q_damion_deliver_normal": {
        ...
        "reward_exp":   120,
        "reward_item":  "copper_bar",
        "desc":         "데리스 본클록이 그린 무기 도면을 글럿에게 전달해라.",
    },
    "q_damion_deliver_hard": {
        ...
        "reward_exp":   280,
        "reward_item":  "mithril_bar",
        "desc":         "데리스 본클록의 비밀 주문서를 오멜룸에게 조용히 전달해라. 아무도 블러그라야 한다.",
    },
    ...
    "q_brooksha_collect_easy": {
        ...
        "desc":         "마이코니드 군락 외곽에서 버섯을 8개 채집해 가져와요.",
    },
    ...
    "q_brooksha_kill_easy": {
        ...
        "desc":         "드레드 할로우에서 몬스터를 5마리 잡고 고기를 확보해와요.",
    },
    ...
    "q_brooksha_kill_hard": {
        ...
        "desc":         "그림포지 몬스터 15마리를 잡아요. 파티 요리 재료가 필요해요.",
    },
    "q_brooksha_deliver_easy": {
        ...
        "desc":         "데리스 본클록의 특제 레시피를 버나드에게 전해줘요.",
    },
    "q_brooksha_deliver_normal": {
        ...
        "reward_exp":   90,
        "reward_item":  "mushroom_soup",
        "desc":         "군주 스포에게 점심 도시락을 배달해요. 경비 순찰 중이에요.",
    },
    ...
    "q_omelum_kill_easy": {
        ...
        "reward_exp":   35,
        "reward_item":  None,
        "desc":         "드레드 할로우 독 몬스터를 5마리 처치해 독 재료를 얻어오시오.",
    },
    ...
    "q_omelum_kill_hard": {
        ...
        "reward_exp":   220,
        "reward_item":  "pot_potion",
        "desc":         "그림포지의 강력한 몬스터 15마리를 처치해 독소를 얻어오시오.",
    },
    "q_omelum_deliver_easy": {
        ...
        "reward_exp":   50,
        "reward_item":  "con_potion_h",
        "desc":         "오멜룸이 조제한 약을 데리스 본클록에게 전달하시오.",
    },
    ...
    "q_omelum_deliver_hard": {
        ...
        "reward_exp":   270,
        "reward_item":  "pot_potion",
        "desc":         "블러그에게 희귀 시약을 전달하고 답신을 받아오시오.",
    },
    ...
    "q_kaelig_kill_easy": {
        ...
        "reward_exp":   60,
        "reward_item":  None,
        "desc":         "드레드 할로우에서 몬스터 5마리를 처치해 전투 감각을 키워라.",
    },
    "q_kaelig_kill_normal": {
        ...
        "reward_exp":   130,
        "reward_item":  None,
        "desc":         "폐허가 된 마을에서 몬스터 12마리를 처치해라.",
    },
    "q_kaelig_kill_hard": {
        "name":         "고급 전투 임무",
        "npc":          "글럿",
        ...
        "reward_exp":   400,
        "reward_item":  None,
        "desc":         "그림포지에서 몬스터 25마리를 처치해라. 실전 훈련이다.",
    },
    ...
    "q_kaelig_deliver_normal": {
        ...
        "reward_exp":   110,
        "reward_item":  None,
        "desc":         "무기 점검 의뢰서를 데리스 본클록에게 가져가라.",
    },
    "q_kaelig_deliver_hard": {
        ...
        "reward_exp":   290,
        "reward_item":  None,
        "desc":         "기밀 전술 서류를 군주 스포에게 전달해라. 절대 열어보지 말 것.",
    },
}
