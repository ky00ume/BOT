...
ENCOUNTER_INTROS = {
    ...
    "카르니스": [
        (
            ...
            "창백한 드로우의 상반신 아래로 거대한 거미의 몸이 이어진다. 손에는 그림자 저주를 밀어내는 문랜턴이 들려 있다. "
            "카르니스는 등불 가까이 몸을 기울인 채, 들리지 않는 목소리에 답하듯 낮게 중얼거린다.\n"
            "\"가까이. 빛에서 벗어나지 마라. 그림자는 굶주렸다.\"\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "🕷️ **카르니스**가 나타났습니다!\n"
            "`/대화 카르니스` — 대화하기\n"
...
DEPARTURE_MESSAGES = {
    ...
    "카르니스": "\"우리는 간다. 빛을 놓치지 마라. 그림자에게 먹이를 주지 마.\" *문랜턴을 들어 올리고 어둠 속으로 향한다*",
...
ENCOUNTER_SHORT_GREETINGS = {
    ...
    "카르니스": "\"가까이. 빛에서 벗어나지 마라. 그림자는 굶주렸다.\"",
