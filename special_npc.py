...
ENCOUNTER_INTROS = {
    "라파엘": [
        (
            "⚡ **불길한 기운이 스쳐간다!**\n\n"
            "허공에서 웃음소리가 들리더니, 붉은 피부에 거대한 뿔을 가진 존재가 나타났다.\n"
    ...
    "카르니스": [
        (
            "🕷️ **어둠 속에서 무언가가 움직인다...**\n\n"
            "여덟 개의 눈이 어둠 속에서 빛나더니, 거미 하체를 가진 존재가 모습을 드러냈다.\n"
            "\"으...으...마제스티가... 마제스티가 보내셨습니다. 잠... 잠깐이면 됩니다.\"\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "🕷️ **카르니스**가 나타났습니다!\n"
            "`/대화 카르니스` — 대화하기\n"
...
DEPARTURE_MESSAGES = {
    ...
    "카르니스": "\"...알겠습니다. 마제스티께 전하겠습니다.\" *어둠 속으로 사라진다*",
