...
ENCOUNTER_INTROS = {
    ...
    "카르니스": [
        (
            ...
            "창백한 드로우의 상반신 아래로 거대한 거미의 몸이 이어진다. 손에는 섀도우랜턴(그림자등불)이 들려 있다. "
            "카르니스는 등불 가까이 몸을 기울인 채, 들리지 않는 목소리에 답하듯 낮게 중얼거린다.\n"
            "책장 아래로 숨는 작은 기척을 여덟 눈이 정확히 좇는다. 입가가 일그러지지만, 손은 움직이지 않는다.\n"
            "\"...또 너냐. 마제스티와 하이네스가 아니었다면 진작 없앴다. 눈에 띄지 마라.\"\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "🕷️ **카르니스**가 나타났습니다!\n"
            "`/대화 카르니스` — 대화하기\n"
...
DEPARTURE_MESSAGES = {
    ...
    "카르니스": "\"마제스티의 뜻이 아니었다면 널 두고 가지도 않았어. ...숨어 있든가.\" *섀도우랜턴(그림자등불)을 들고 멀어진다*",
    "루바토": "\"벌써 가? 좋아, 다음 소절은 다음에 들려줄게. 살아서 다시 보자!\" *리라를 끌어안고 손을 흔든다*",
}

# ── NPC 등장 대사 (짧은 버전, PIL 이미지용) ────────────────────────────────
ENCOUNTER_SHORT_GREETINGS = {
    "라파엘": "\"오, 마침 찾고 있었어. 흥미로운 제안이 있는데... 거절하기 아깝지 않겠어?\"",
    "카르니스": "\"...또 너냐. 마제스티와 하이네스가 아니었다면 진작 없앴다.\"",
    "루바토": "\"어라, 또 만났네! 살아 있으면 됐지. 한 곡 들을래?\"",
}

ENCOUNTER_NPC_ROLES = {
    "라파엘": "악마 / 거래자",
    "카르니스": "드라이더 / 섀도우랜턴(그림자등불)",
    "루바토": "티플링 음유시인 / 류트 주력 · 리라 연주",
}
