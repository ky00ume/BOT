...
WORLD_ACTIVITY_ZONES = {
    ...
    "아다만틴 대장간": [
        {"kind": "mine", "zone": "아다만틴 심층 광맥", "label": "아다만틴 심층 광맥", "emoji": "💎"},
    ],
    "샤의 고대 사원": [
        {"kind": "gather", "zone": "샤의 잔해 채집지", "label": "사원 잔해 채집", "emoji": "🕯️"},
    ],
    "셀루네 전초기지": [
        {"kind": "gather", "zone": "셀루네 수정지", "label": "달빛 수정 채집", "emoji": "🌙"},
    ],
    "곪아가는 만": [
        {"kind": "fish", "zone": "곪아가는 만", "label": "곪아가는 만 낚시터", "emoji": "🎣"},
    ],
    "비버뱅 군락": [
        {"kind": "gather", "zone": "비버뱅 군락지", "label": "위험 버섯 채집", "emoji": "💥"},
    ],
}
